...
public class TabularOntology {
    ...
    static {
        ...
        TABLE_CLASS = valueFactory.createIRI("http://unifiedviews.eu/ontology/t-relationaltordf/Table");
        ROW_CLASS = valueFactory.createIRI("http://unifiedviews.eu/ontology/t-relationaltordf/Row");
    }
